...
set SDK_INCLUDE_DIR=D:\app\Microsoft SDKs\Windows\v7.1\Include
...
set PYTHON=D:\app\py\python27
set PYTHON_VER=27

echo "Configuring Visual Studio..."
call "%VS_DIR%\Community\VC\Auxiliary\Build\vcvarsall.bat" %TOOLCHAIN%
