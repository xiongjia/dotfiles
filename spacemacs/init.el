...
you should place you code here."
  ...
  (setq gnuplot-program "d:/usr/misc/gnuplot/gp426win32/gnuplot/bin/pgnuplot.exe")
  ...
  (setq my-dropbox-root "E:/var/datum/Dropbox")
  (setq org-directory (concat my-dropbox-root "/org"))
  ...
  (setq org-capture-templates
    '(("t" "TODO" entry (file+headline (concat org-directory "/tasks.org") "Tasks")
       "* TODO %?\n %i\n %a")
      ("a" "Archive" entry (file+headline (concat org-directory "/notes.org") "Archive")
       "* Entered on %U\n %?\n %i\n %a")
      ("n" "Notes" entry (file+headline (concat org-directory "/notes.org") "Index")
       "* Entered on %U\n %?\n %i\n %a")))
  ;; (setq debug-on-error t)
  ;; org project
  ;; (setq abathur-root "E:/dev/github/abathur")
  (defconst abathur-root
    (expand-file-name "e:/dev/github/abathur")
    "abathur root folder.")
